...
8. Server reads the selected product view, background reference, and style prompt from config.
  ...
  "backgrounds": [
    {
      "id": "premium-clean",
      "name": "高级简洁",
      "image": "/assets/backgrounds/premium-clean.png",
      "stylePrompt": "premium commercial poster, clean lighting, elegant product advertising, no text"
    }
  ],
  "logo": {
...
- Title and subtitle placed in a controlled text area.
