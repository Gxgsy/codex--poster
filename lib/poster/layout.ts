...
export const posterLayout = {
  title: { x: 122, y: 540, width: 1150, fontSize: 96, lineHeight: 108, maxChars: 12, maxLines: 2 },
  subtitle: { x: 122, y: 660, width: 1150, fontSize: 48, lineHeight: 64, maxChars: 20, maxLines: 3 },
